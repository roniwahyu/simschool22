    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="editSectionForm" method="post" action="<?= base_url('sections/update/' . $section['id']) ?>" novalidate>
                        <?= csrf_field() ?>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="section" name="section" 
                                           value="<?= esc($section['section'] ?? '') ?>" required
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="is_active" name="is_active">
                                        <option value="yes" <?= ($section['is_active'] ?? 'yes') === 'yes' ? 'selected' : '' ?>>Active</option>
                                        <option value="no" <?= ($section['is_active'] ?? 'yes') === 'no' ? 'selected' : '' ?>>Inactive</option>
                                    </select>
                                    <div class="invalid-feedback"></div>
                                </div>
                            </div>
